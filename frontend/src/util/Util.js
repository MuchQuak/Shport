...
export const errorSuffix = (suffix) => <p className='error nomargin bold'>Error {suffix}!</p>;

export const loading = <p className='nomargin bold'>Loading...</p>;

export const loadingSuffix = (suffix) => <p className='nomargin bold'>Loading {suffix}...</p>;